...
export class UndefinedUniqAsset implements IUniqueAsset {
  ...
  constructor(public id: number, public owner: string, public name: string, public name2: string, public name3: string, public  assetPlainText: string, public imageRessourcesIPFSAddress: string, public certifier: Certifier, public assetType: number, public changeDate: Date, public rawData: number[]) {
...
export class UniqMotorcycle implements IUniqueAsset {
  ...
  constructor(public id: number, public owner: string, public name: string, public name2: string, public name3: string, public  assetPlainText: string, public imageRessourcesIPFSAddress: string, public certifier: Certifier, public assetType: number, public changeDate: Date, public horsepower: number, public weight: number, public topSpeed: number, public customizationGrade: number, public vintageGrade: number, public techGrade: number) {
  }
